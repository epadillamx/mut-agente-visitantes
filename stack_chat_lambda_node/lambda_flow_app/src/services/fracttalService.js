...
class FracttalService {
    ...
    log(message) {
        console.log(`[FRACTTAL] ${message}`);
    }

    error(message, errorData) {
        console.error(`[FRACTTAL] ${message}`, errorData);
    }
    ...
    async createWorkRequest(ticketData) {
        ...
        console.log('[FRACTTAL] Payload:', JSON.stringify(payload, null, 2));
 ...
 */
function getFracttalService(credentials) {
    if (!fracttalInstance) {
